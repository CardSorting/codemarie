...
export const SettingsPanelContent: React.FC<SettingsPanelContentProps> = ({
	...
	}, [isWaitingForCodemarieAuth, controller, fetchAccountInfo])
	...
	const handleProviderSelect = useCallback(
		...
		[stateManager, startCodexAuth, handleCodemarieLogin, startOcaAuth, isOcaAuthenticated, controller, refreshModelIds],
	)
