...
<Tip>
  Subagents is an experimental feature. For complex, high-trust parallel execution that includes file editing and wave-level governance, see the [Multi-Agent System (MAS)](/multi-agent-system) documentation.
</Tip>
