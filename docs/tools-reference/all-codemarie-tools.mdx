...
For the most up-to-date implementation details, see the [Cline repository](https://github.com/codemarie/codemarie/blob/main/src/core/prompts/system-prompt/tools).
