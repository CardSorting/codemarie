...
async function main() {
	log("\n\n\nStarting codemarie-core service...\n\n\n")
...
function setupHostProvider(extensionContext: any, extensionDir: string, dataDir: string) {
	...
	// codemarie-core expects the binaries to be unpacked in the directory where it is running.
...
/**
 * Gracefully shutdown the codemarie-core process by:
...
function showHelp() {
	Logger.log(`
Codemarie Core - Standalone Server
