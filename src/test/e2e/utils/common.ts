...
export const addSelectedCodeToCodemarieWebview = async (_page: Page) => {
	...
	const addToCodemarie = _page.getByText(/Add to Codemarie/i)
	await addToCodemarie.waitFor({ state: "visible" })
