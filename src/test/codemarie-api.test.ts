...
import type { CodemarieAPI } from "../exports/codemarie"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("CodemarieAPI Core Functionality", () => {
	let api: CodemarieAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createCodemarieAPI expects
		...
		// Create API instance
		api = createCodemarieAPI(mockController)
	})
