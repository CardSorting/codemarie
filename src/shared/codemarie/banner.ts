...
export interface BannerCardData {
	...
	/** Only show to Codemarie users */
	isCodemarieUserOnly?: boolean
}
...
export const BANNER_DATA: BannerCardData[] = [
	...
	// Minimax free promo banner
	{
		...
		description: "SOTA coding capability with lightning fast inference, free in Codemarie.",
		actions: [
			{
				title: "Try now",
				action: BannerActionType.SetModel,
	...
	// ChatGPT integration banner
	{
		...
		icon: "megaphone",
		title: "Use ChatGPT with Codemarie",
		description:
			"Bring your ChatGPT subscription to Codemarie! Use your existing plan directly with no per token costs or API keys to manage.",
		actions: [
			{
				title: "Connect",
	...
	// Jupyter Notebooks banner
	{
		...
		description:
			"Comprehensive AI-assisted editing of `.ipynb` files with full cell-level context awareness. [Learn More →](https://docs.codemarie.bot/features/jupyter-notebooks)",
	},
	...
	// Platform-specific banner (Windows)
	{
		...
		icon: "terminal",
		title: "Codemarie CLI Info",
		platforms: ["windows"] satisfies BannerCardData["platforms"],
		description:
			"Available for macOS and Linux. Coming soon to other platforms. [Learn more](https://docs.codemarie.bot/codemarie-cli/overview)",
	},
	...
	// Info banner with inline link
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use Codemarie in Right Sidebar",
		description:
			"For the best experience, drag the Codemarie icon to your right sidebar. This keeps your file explorer and editor visible while you chat with Codemarie, making it easier to navigate your codebase and see changes in real-time. [See how →](https://docs.codemarie.bot/features/customization/opening-codemarie-in-sidebar)",
	},
]
