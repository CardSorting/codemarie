...
/**
 * Calculates API metrics from an array of CodemarieMessages.
 *
 ...
 */
export function getApiMetrics(messages: CodemarieMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: CodemarieMessage[]): number {
