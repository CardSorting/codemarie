 ...
 * @returns A new array of CodemarieMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: CodemarieMessage[]): CodemarieMessage[] {
