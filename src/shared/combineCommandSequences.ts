...
/**
 * Combines sequences of command and command_output messages in an array of CodemarieMessages.
 *
 * This function processes an array of CodemarieMessages objects, looking for sequences
 ...
 * @returns A new array of CodemarieMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: CodemarieMessage[]): CodemarieMessage[] {
	const combinedCommands: CodemarieMessage[] = []
