 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "codemarie.generatedMachineId"
 ...
 * This is updated to Codemarie User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Codemarie User ID.
