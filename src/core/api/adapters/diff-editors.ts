 ...
 */
export function convertApplyPatchToolCalls(messages: Array<CodemarieStorageMessage>): Array<CodemarieStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<CodemarieStorageMessage>): Array<CodemarieStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
