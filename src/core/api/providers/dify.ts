...
export class DifyHandler implements ApiHandler {
	 ...
	 */
	async uploadFile(file: Buffer, filename: string, user: string = "codemarie-user"): Promise<DifyFileResponse> {
	 ...
	 */
	async stopGeneration(taskId: string, user: string = "codemarie-user"): Promise<void> {
	 ...
	 */
	async deleteConversation(conversationId: string, user: string = "codemarie-user"): Promise<void> {
