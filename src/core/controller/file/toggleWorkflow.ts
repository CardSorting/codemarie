import { CodemarieRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/codemarie/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<CodemarieRulesToggles> {
