import { EmptyRequest, String as ProtoString } from "@shared/proto/codemarie/common"
 ...
 */
export async function relaunchChromeDebugMode(controller: Controller, _: EmptyRequest): Promise<ProtoString> {
	try {
