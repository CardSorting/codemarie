...
import { SapAiCoreModelDeployment, SapAiCoreModelsRequest, SapAiCoreModelsResponse } from "@/shared/proto/codemarie/system"
...
async function fetchAiCoreDeploymentsAndOrchestration(
	...
	try {
		...
		// biome-ignore lint/suspicious/noExplicitAny: SAP AI Core API returns complex objects
