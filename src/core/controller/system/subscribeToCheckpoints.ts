import { CheckpointEvent, CheckpointEvent_OperationType, CheckpointSubscriptionRequest } from "@shared/proto/codemarie/system"
...
import { broadcastCheckpointEvent } from "./SystemUpdatesEmitter"
...
export async function sendCheckpointEvent(eventData: CheckpointEventData): Promise<void> {
	...
	await broadcastCheckpointEvent(event)
