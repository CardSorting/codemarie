...
import { McpMarketplaceCatalog } from "@shared/proto/codemarie/system"
import { Logger } from "@/shared/services/Logger"
import { Controller } from "../index"
import { getProtobusRequestRegistry, StreamingResponseHandler } from "../protobus-handler"
import { broadcastMcpMarketplace } from "./SystemUpdatesEmitter"
...
export async function sendMcpMarketplaceCatalogEvent(catalog: McpMarketplaceCatalog): Promise<void> {
	...
	await broadcastMcpMarketplace(catalog)
