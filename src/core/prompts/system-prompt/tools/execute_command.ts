...
const NATIVE_GPT_5: CodemarieToolSpec = {
	...
	id: CodemarieDefaultTool.BASH,
	name: CodemarieDefaultTool.BASH,
	description:
...
export const execute_command_variants: CodemarieToolSpec[] = [GENERIC, NATIVE_GPT_5, NATIVE_NEXT_GEN, GEMINI_3]
