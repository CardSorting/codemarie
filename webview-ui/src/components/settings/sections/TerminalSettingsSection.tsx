				...
				<div className="mb-5" id="terminal-settings-section">
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							Set how long Codemarie waits for shell integration to activate before executing commands. Increase this
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground)">
							When enabled, Codemarie will reuse existing terminal windows that aren't in the current working directory.
