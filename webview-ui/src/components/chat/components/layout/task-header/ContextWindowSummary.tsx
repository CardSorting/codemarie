...
const AccordionItem = memo<{
	...
	return (
		<div className="flex flex-col w-full">
			<button
				className="flex justify-between items-center gap-1 cursor-pointer hover:bg-foreground/5 rounded p-0.5 transition-colors w-full border-none bg-transparent text-inherit font-inherit"
				onClick={handleClick}
				onKeyDown={(e) => {
