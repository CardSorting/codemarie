	...
	({ currentTaskItemId, lastProgressMessageText, showPlaceholderWhenEmpty }) => {
		...
		return (
			<button
				...
				className="relative rounded-sm bg-toolbar-hover/65 flex flex-col gap-1.5 select-none hover:bg-toolbar-hover overflow-hidden opacity-80 hover:opacity-100 transition-[transform,box-shadow] duration-200 cursor-pointer border-none w-full text-left font-inherit p-0"
				...
				{isExpanded && (
					<button
						className="mx-1 pb-2 px-1 relative w-full text-left bg-transparent border-none font-inherit block p-0"
