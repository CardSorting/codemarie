...
const ContextWindow: React.FC<ContextWindowProgressProps> = ({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: onMouseLeave is used to manage tooltip state
		<div className="flex flex-col my-1.5" onMouseLeave={debounceCloseHover} role="presentation">
						...
						<HoverCard>
							...
							<HoverCardTrigger asChild>
								...
								<button
									...
									className="relative w-full text-foreground context-window-progress brightness-100 border-none bg-transparent p-0 block"
									onFocus={handleFocus}
									ref={progressBarRef}
									type="button">
									<Progress
