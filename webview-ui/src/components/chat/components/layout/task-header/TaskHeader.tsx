		...
		<div className="py-2 px-4 flex flex-col gap-2">
			...
			<div
				...
				<button
					...
					className="flex justify-between items-center cursor-pointer border-none bg-transparent w-full p-0 text-inherit font-inherit"
				...
				{isTaskExpanded && (
					<div className="flex flex-col break-words" key={`task-details-${currentTaskItem?.id}`}>
						<div
							...
							tabIndex={isTextOverflowing ? 0 : undefined}>
							{highlightedText}
						</div>
