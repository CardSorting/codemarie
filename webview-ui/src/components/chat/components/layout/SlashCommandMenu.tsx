...
interface SlashCommandMenuProps {
	...
	// biome-ignore lint/suspicious/noExplicitAny: Remote workflows have dynamic structure
	remoteWorkflows?: any[]
...
const SlashCommandMenu: React.FC<SlashCommandMenuProps> = ({
	...
	return (
		// biome-ignore lint/a11y/noStaticElementInteractions: onMouseDown is used to prevent focus theft from the input
		<div
