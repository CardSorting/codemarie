...
export const MessagesArea: React.FC<MessagesAreaProps> = ({
	...
	const scrolledPastUserMessageIndex = useMemo(() => {
		...
		return messages.findIndex((msg) => msg.ts === scrolledPastUserMessage.ts)
	}, [messages, scrolledPastUserMessage])
	...
	// Use the new simplified hook for waiting/thinking state
	const { showThinkingLoaderRow } = useResponseState(modifiedMessages, messages, groupedMessages)
