...
const createTextMessage = (ts: number, text: string): CodemarieMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): CodemarieMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): CodemarieMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
