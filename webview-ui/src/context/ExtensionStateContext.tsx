...
export const ExtensionStateContextProvider: React.FC<{
	...
	useEffect(() => {
		const hasCodemarieProvider =
			state.apiConfiguration?.actModeApiProvider === "codemarie" || state.apiConfiguration?.planModeApiProvider === "codemarie"
		if (hasCodemarieProvider && codemarieModels === null) {
			refreshCodemarieModels()
		}
	}, [state.apiConfiguration?.actModeApiProvider, state.apiConfiguration?.planModeApiProvider, codemarieModels, refreshCodemarieModels])
